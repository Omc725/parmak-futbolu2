...
import { Team, Difficulty } from '../tipler';

interface PenaltiAtislariProps {
  playerTeam: Team;
  aiTeam: Team;
...
const PenaltiAtislari: React.FC<PenaltiAtislariProps> = ({ playerTeam, aiTeam, difficulty, onFinish }) => {
...
export default PenaltiAtislari;