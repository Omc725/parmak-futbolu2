...
import { Tournament, Team as TeamType, TournamentNode } from '../tipler';
...
const TurnuvaFiksturu: React.FC<TournamentBracketProps> = ({ tournament }) => {
...
export default TurnuvaFiksturu;