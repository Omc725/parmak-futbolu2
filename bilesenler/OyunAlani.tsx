...
import { Team, Difficulty, Player, Ball } from '../tipler';
import { AI_SPEED_MULTIPLIERS } from '../sabitler';
...
const OyunAlani: React.FC<GameCanvasProps> = ({
  player1Team,
  player2Team,
  isOpponentAI,
  difficulty,
